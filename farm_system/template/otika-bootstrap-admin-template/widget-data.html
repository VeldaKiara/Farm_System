              ...
              <div class="col-12 col-sm-12 col-lg-5">
                <div class="card profile-widget">
                  <div class="profile-widget-header">
                    <img alt="image" src="assets/img/users/user-1.png" class="rounded-circle profile-widget-picture">
                ...
                <div class="card mt-4">
                  ...
                  <div class="card-body pb-0">
                    <div class="row">
                      <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                        <div class="avatar-item">
                          <img alt="image" src="assets/img/users/user-1.png" class="img-fluid" data-toggle="tooltip"
                            title="Ashton Cox">
                      ...
                      <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                        <div class="avatar-item">
                          <img alt="image" src="assets/img/users/user-2.png" class="img-fluid" data-toggle="tooltip"
                            title="John Doe">
                      ...
                      <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                        <div class="avatar-item">
                          <img alt="image" src="assets/img/users/user-3.png" class="img-fluid" data-toggle="tooltip"
                            title="Airi Satou">
                      ...
                      <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                        <div class="avatar-item">
                          <img alt="image" src="assets/img/users/user-4.png" class="img-fluid" data-toggle="tooltip"
                            title="Hasan Basri">
                          <div class="avatar-badge" title="Author" data-toggle="tooltip"><i
                              class="fas fa-pencil-alt"></i></div>
                        </div>
                    ...
                    <div class="row">
                      <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                        <div class="avatar-item">
                          <img alt="image" src="assets/img/users/user-5.png" class="img-fluid" data-toggle="tooltip"
                            title="Airi Satou">
                          <div class="avatar-badge" title="Editor" data-toggle="tooltip"><i class="fas fa-wrench"></i>
                          </div>
                        </div>
