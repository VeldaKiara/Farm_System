...
<!-- icon-feather.html  21 Nov 2019 03:59:21 GMT -->
<head>
	<meta charset="UTF-8">
					...
					<ul class="sidebar-menu">
						...
						<li class="dropdown active">
							...
							<ul class="dropdown-menu">
								...
								<li class="active"><a class="nav-link" href="icon-feather.html">Feather Icons</a></li>
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="row icon-feather-container">
											...
											<div class="col-sm-6 col-md-4 col-lg-3">
												<i data-feather="phone-missed"></i> phone-miss
											</div>
											<div class="col-sm-6 col-md-4 col-lg-3">
