...
<!-- chart-amchart.html  21 Nov 2019 03:56:04 GMT -->
<head>
  <meta charset="UTF-8">
        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                <li class="active"><a class="nav-link" href="chart-amchart.html">amChart</a></li>
...
<!-- chart-amchart.html  21 Nov 2019 03:58:53 GMT -->
</html>