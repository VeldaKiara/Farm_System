...
<!-- buttons.html  21 Nov 2019 03:51:00 GMT -->
<head>
  <meta charset="UTF-8">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a class="nav-link" href="buttons.html">Buttons</a></li>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="buttons">
                      ...
                      <a href="#" class="btn btn-icon icon-left btn-warning"><i class="fas fa-exclamation-triangle"></i>
                        Warning</a>
