...
<!-- chart-echart.html  21 Nov 2019 03:58:55 GMT -->
<head>
  <meta charset="UTF-8">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a class="nav-link" href="chart-echart.html">eChart</a></li>
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-6">
                <div class="card">
                  <div class="card-header">
                    <h4>Bar CHart With Line</h4>
                  </div>
                  <div class="card-body">
                    <div id="echart_bar_line" class="chartsh chart-shadow"></div>
                  </div>
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-6">
                <div class="card">
                  ...
                  <div class="card-body">
                    <div id="echart_line" class="chartsh chart-shadow"></div>
                  </div>
                </div>
              </div>
            </div>
...
<!-- chart-echart.html  21 Nov 2019 03:58:59 GMT -->
</html>