...
<!-- gmaps-draggable-marker.html  21 Nov 2019 04:04:53 GMT -->
<head>
  <meta charset="UTF-8">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="gmaps-draggable-marker.html">Draggable Marker</a></li>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="alert alert-info">
                      You can drag the marker, change the value of longitude and latitude at the above input and click
                      on the desired position on the map to change the position of the marker.
                    </div>
...
<!-- gmaps-draggable-marker.html  21 Nov 2019 04:04:54 GMT -->
</html>