...
<!-- progress.html  21 Nov 2019 03:51:03 GMT -->
<head>
  <meta charset="UTF-8">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a class="nav-link" href="progress.html">Progress</a></li>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="progress mb-3">
                      <div class="progress-bar" role="progressbar" data-width="15%" aria-valuenow="15" aria-valuemin="0"
                    ...
                    <div class="progress mb-3">
                      <div class="progress-bar" role="progressbar" data-width="75%" aria-valuenow="75" aria-valuemin="0"
                        aria-valuemax="100"></div>
                    </div>
                    <div class="progress mb-3">
              ...
              <div class="col-12 col-md-6 col-lg-6">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="progress mb-3">
                      <div class="progress-bar bg-info" role="progressbar" data-width="50%" aria-valuenow="50"
                        aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="progress mb-3">
                    ...
                    <div class="progress mb-3">
                      <div class="progress-bar bg-danger" role="progressbar" data-width="100%" aria-valuenow="100"
                        aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="progress mb-3">
                      <div class="progress-bar bg-info" role="progressbar" data-width="100%" aria-valuenow="100"
                        aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </div>
                </div>
