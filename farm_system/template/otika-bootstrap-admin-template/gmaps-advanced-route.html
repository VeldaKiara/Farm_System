...
<!-- gmaps-advanced-route.html  21 Nov 2019 04:04:47 GMT -->
<head>
  <meta charset="UTF-8">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="map"></i><span>Google
                  Maps</span></a>
              <ul class="dropdown-menu">
                <li class="active"><a href="gmaps-advanced-route.html">Advanced Route</a></li>
...
<!-- gmaps-advanced-route.html  21 Nov 2019 04:04:53 GMT -->
</html>