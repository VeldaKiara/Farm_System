...
<!-- chart-chartjs.html  21 Nov 2019 03:58:59 GMT -->
<head>
  <meta charset="UTF-8">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a class="nav-link" href="chart-chartjs.html">Chartjs</a></li>
          ...
          <div class="section-body">
            ...
            <div class="row">
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  <div class="card-header">
                    <h4>Line With Gradient Color</h4>
                  </div>
                  <div class="card-body">
...
<!-- chart-chartjs.html  21 Nov 2019 03:59:03 GMT -->
</html>